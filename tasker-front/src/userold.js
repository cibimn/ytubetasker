...
//                         <h1 className="w-full mb-4 text-4xl text-center">Register</h1>
//                         {/* First Name */}
//                         <div className="mb-4">
...
//                             className="w-full p-2 mt-1 mb-1 border rounded-md" />
                        ...
                        <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                            ...
                            <div class="intro-x mt-2 text-slate-400 dark:text-slate-400 xl:hidden text-center">A few more clicks to sign in to your account. Manage all your youtube videos in one place</div>
                                <div class="intro-x mt-8">
                                    <input type="text" name="firstName" placeholder="First Name" onChange={handleChange} className="block px-4 py-3 intro-x login__input form-control" />
                                    <input type="text" name="lastName" placeholder="Last Name" onChange={handleChange} className="block px-4 py-3 mt-4 intro-x login__input form-control" />
                                    <input type="text" name="email" placeholder="Email" onChange={handleChange} className="block px-4 py-3 mt-4 intro-x login__input form-control" />
                                    <input type="password" name="password" placeholder="Password" onChange={handleChange} className="block px-4 py-3 mt-4 intro-x login__input form-control" />
                                ...
                                <div className="mt-2 text-xs intro-x sm:text-sm">
                                    {passwordStrengthText}
                                </div>
